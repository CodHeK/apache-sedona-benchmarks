...
'''
jia.yu1@wsu.edu
spark-submit --master yarn --jars hdfs:/data/geotools-wrapper-1.1.0-25.2.jar,hdfs:/data/sedona-python-adapter-3.0_2.12-1.2.0-incubating.jar knn_polygons.py --deploy-mode cluster
'''
